...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.133         // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       505        // (mA) RMS current. Multiply by 1.414 for peak current.
