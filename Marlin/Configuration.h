...
#define STRING_CONFIG_H_AUTHOR "(sgh)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3Pro"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 52.25
  #define DEFAULT_bedKi 10.21
  #define DEFAULT_bedKd 178.36
