...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @sghnsk" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kossel Linear Plus - MKS SGEN_L V2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from pid autotune. "M303 E-1 C8 S60" to run autotune on the bed at 60 degreesC for 8 cycles
    ...
    #define DEFAULT_bedKp 1102.32
    #define DEFAULT_bedKi 197.88
    #define DEFAULT_bedKd 1535.11
  #endif
